export const constants = {
  CASE_STUDY_BUTTON_TITLE: 'read the paper',
  LATEST_NEWS_BUTTON_TITLE: 'read',
  CASE_STUDY_LEARN_CASE_BUTTON: 'learn case study',
  ...
  EVENTS_SECTION_DISCOVER_BUTTON_TEXT: 'discover all',
  EVENTS_SECTION_LATEST_NEWS_TITLE: 'Latest news',
  EVENTS_SECTION_HACKATHONS_TITLE: 'Hackathons',
  EVENTS_SECTION_SEMINARS: 'Journal Clubs & Seminars',
  TICKER_TITLE_AS_SEEN_IN: 'As seen in',
